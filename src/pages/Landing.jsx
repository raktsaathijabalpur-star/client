...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f2f0]">
      ...
      <main className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-14 items-center">
        <div>
        ...
        <div className="space-y-5">
          <button
            ...
            className="w-full text-left bg-brand-50 border border-brand-100 rounded-2xl p-6 hover:border-brand-300 transition-colors"
          >
      ...
      <footer className="max-w-6xl mx-auto px-6 pb-10 text-center text-gray-400 text-xs flex items-center justify-center gap-2">
